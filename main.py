...
# Função para requisitar ao Roblox e extrair tokens
def requisicao_roblox():
    try:
        url = "https://www.roblox.com"
        params = {
            '62f8ce9f74b12f84c123cc23437a4a32': '882a8490361da98702bf97a021ddc14d',
            'crypt_efe68487_9689b1628dd3d53b0f9723db80b78cc5': "fdb3bf0ca6c13f3c149e1654c1dd6a7706125f9b",
            'anakravitz+7dd1f8fa9435e6aafd2f96eb3c03ffd0257435cb': "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzb21lIjoicGF5bG9hZCJ9.4twFt5NiznN84AWoo1d7KO1T_yoc0Z6XOpOVswacPZg",
            'random_string': "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",
            '2b93c3a24618363a84e2607579de9e100782e656921a8a26ed813246c77b17e9': 'random_value'
        }
        ...
        response = roblox_session.get(url, params=params, timeout=10)
        if response.status_code == 200:
            bot_log("Requisição HTTPS ao Roblox realizada com sucesso!")
