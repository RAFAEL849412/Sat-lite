...
class imgui_window:
    ...
    def create_window(name):
        return f"[imgui_window] Janela criada: {name}"

class gl_utils:
    @staticmethod
    def init_opengl_context():
        return "[gl_utils] Contexto OpenGL inicializado"

class text_utils:
    @staticmethod
    def render_text(text):
        return f"[text_utils] Texto formatado: {text}"

# Modo de teste autônomo
if __name__ == "__main__":
    print(imgui_window.create_window("app.py"))
    print(gl_utils.init_opengl_context())
    print(text_utils.render_text("Testando utils"))
