...
import sys
import physics_module as pymunk
import pygame
from pygame.locals import *
from pygame.color import *
from pygame_util import draw, from_pygame
...
def post_solve_arrow_hit(space, arbiter):
    ...
    if ti.length > 300:
        ...
        callbacks.append([stick_arrow_to_target, arrow_body, other_body, position, space])
...
def main():
    ...
    while running:
        ...
        for flying_arrow in flying_arrows:
            ...
            flying_arrow.apply_impulse(-flight_direction*drag_force_magnitude, arrow_tail_position)
